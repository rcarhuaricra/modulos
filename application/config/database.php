...
$db['portal_msi']['hostname'] = "localhost";
$db['portal_msi']['port'] = "";
$db['portal_msi']['username'] = "root";
$db['portal_msi']['password'] = "";
$db['portal_msi']['database'] = "sanisidro_dba";
$db['portal_msi']['dbdriver'] = "mysqli";
$db['portal_msi']['dbprefix'] = "";
$db['portal_msi']['pconnect'] = FALSE;
$db['portal_msi']['db_debug'] = (ENVIRONMENT !== 'production');
$db['portal_msi']['cache_on'] = FALSE;
$db['portal_msi']['cachedir'] = "";
$db['portal_msi']['char_set'] = "utf8";
$db['portal_msi']['dbcollat'] = "utf8_general_ci";
$db['portal_msi']['swap_pre'] = "";
$db['portal_msi']['encrypt'] = FALSE;
$db['portal_msi']['compress'] = FALSE;
